// Generated by @wagmi/cli@0.1.11 on 3/5/2023 at 5:20:33 AM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link banditClubABI}__ and `functionName` set to `"previewSubscriptionFeeClaim"`.
 */
...
>(
  ...
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof banditClubABI, "previewSubscriptionFeeClaim", TSelectData>);
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link banditClubABI}__ and `functionName` set to `"userAdddressToContracts"`.
 */
export function useBanditClubUserAdddressToContracts<
  TSelectData = ReadContractResult<
    typeof banditClubABI,
    "userAdddressToContracts"
  >
>(
  config: Omit<
    UseContractReadConfig<
  ...
  return useContractRead({
    abi: banditClubABI,
    functionName: "userAdddressToContracts",
    ...config,
  } as UseContractReadConfig<typeof banditClubABI, "userAdddressToContracts", TSelectData>);
}
